...
using ScarletAuth.STS.Identity.Configuration;
using ScarletAuth.STS.Identity.Configuration.ApplicationParts;
using ScarletAuth.STS.Identity.Configuration.Constants;
using ScarletAuth.STS.Identity.Configuration.Interfaces;
using ScarletAuth.STS.Identity.Helpers.Localization;

namespace ScarletAuth.STS.Identity.Helpers
{
