...
using ScarletAuth.Admin.Api.Configuration.ApplicationParts;
using ScarletAuth.Admin.Api.Configuration.AuditLogging;
using ScarletAuth.Admin.Api.Configuration.Constants;
using ScarletAuth.Admin.Api.Helpers.Localization;
...
namespace ScarletAuth.Admin.Api.Helpers
{
