...
using ScarletAuth.Admin.Api.Configuration;
using ScarletAuth.Admin.Api.Configuration.Authorization;
using ScarletAuth.Admin.Api.Configuration.Constants;
using ScarletAuth.Admin.Api.ExceptionHandling;
using ScarletAuth.Admin.Api.Helpers;
using ScarletAuth.Admin.Api.Mappers;
using ScarletAuth.Admin.Api.Resources;
...
using ScarletAuth.Shared.Dtos;
using ScarletAuth.Shared.Dtos.Identity;

namespace ScarletAuth.Admin.Api
{
